...
if(mysqli_num_rows($Validate)<=0) 
{
   ...
   $insert="INSERT INTO users(RegisterNo, Name, Phone,  Gender,  BloodGroup, DOB,id_no,durationfrom,durationto,emargency_no,nationality,height,weight,check1,check2,check3,check4,check5,check6,check7,healthdetails,Place, Occupation, SQLStatus) VALUES ('$RegisterNo', '$Name', '$Phone', '$Gender', '$BloodGroup', '$DOB',$id','$durationfrom','$durationto','$emargency','$nationality','$height','$weight','$check','$check2','$check3','$check4','$check5','$check6','$check7','$healthdetails','$Place', '$FamilyDetails', '$Occupation', 'Estadio', 1)";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="POST" action="new.php"  data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
